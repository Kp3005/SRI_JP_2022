   ...
   if(mysqli_num_rows($qry) > 0){
      while($data = mysqli_fetch_assoc($qry)){
         ...
         if(mysqli_num_rows($cart_query) > 0){
          ...
          $detail_query = mysqli_query($con, "INSERT INTO `order_pick`(`c_id`, `c_name`, `total`, `store`, `location`, `o_date`, `status`, `feedback`, `token`) VALUES ('$cid','$total_product','$price_total','$store','$location',current_timestamp,'0','0','$rand_id')") or die('query failed');
          $product_name=[];
